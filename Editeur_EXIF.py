# *******************************************************
# Nom ......... : Editeur_EXIF.py
# Rôle ........ : Application d'édition de métadonnées EXIF pour les images (sans cartes)
# Auteur ...... : Maxim Khomenko
# Version ..... : V1.0.0 du 31/05/2024
# Licence ..... : Réalisé dans le cadre du cours de l'Architecture des Machines
# Usage ....... : Exécuter le script avec "streamlit run Editeur_EXIF.py" pour démarrer l'application
# *******************************************************
